# $Id: README.txt,v 1.4.2.4 2009/12/01 02:05:33 cpliakas Exp $
...
- Search Lucene Facets

Search Lucene Facets adds a facet API and UI to all modules that implement
Search Lucene API. Search Lucene Content has pre-defined facets so that users
can filter search results by items such as taxonomy terms and node author
